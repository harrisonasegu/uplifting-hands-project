...
// data table columns
import { activeUsersDataTableColumn as dataTableColumns } from '@/table-columns/users_active'
...
const dataSource = userStore.getAllActiveUsers
  ...
  handleDataTableButtonClick = (isButtonClicked: boolean) => {
    ...
    switch (dataTableClickedButtonProp.buttonClicked) {
      ...
      case 'deactivate user':
        // update modal prop
        modalAttrs.modalTitle = 'Deactivate User'
...
<template>
  ...
  >
    <template #modalContent>
      ...
      <ActionComment
        v-if="modalAttrs.modalTitle === 'Deactivate User'"
